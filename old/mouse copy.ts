...
import { IPos } from "../src/ui/types/pos.js";
import { EMouseType } from "../src/ui/types/mouse.js";
import { ToggleButton } from "../src/ui_components/button.js";
import { boundingRect } from "../src/ui/bounding_rect.js";
import { CLickableMixinClass } from "../src/ui/clickable_rect.js";
...
export class MouseHandler{
    ...
    public static mouseDownRects:CLickableMixinClass[]=[];
    public static mouseHoverRects:CLickableMixinClass[]=[];
    public static isMouseDown=false;
    public static topMostSave:CLickableMixinClass[]=[];

    static callbackObjects:CLickableMixinClass[]=[];
    ...
    private static down(e:EMouseType,pos:IPos){
        ...
        //boundingRect.draw();
        //var overlapping=boundingRect.overlappHierarchy(pos);
...
//
    ...
    public static getTopMost(rects:CLickableMixinClass[]){

        let previousWinner=0;
        let winnerRects:CLickableMixinClass[]=[];
    ...
    //    return boundingRect.overlappHierarchy(pos);
    //}
}