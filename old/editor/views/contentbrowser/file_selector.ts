...
import { HoverPressButton, ToggleButton, ToggleButtonGroup } from "../../../../src/ui_components/button.js";
...
export class FileSelector extends Clickable {
    ...
    //topDragArea;
    fileTypeHzBox;
    fileType=FileTypes.image;//default value
    bottomHzBox;
    cancelButton;
    createButton;
    constructor(contentBrowser: ContentBrowser) {
        ...
        group.setCurrentToggled(this.fileTypeHzBox.children[0] as ToggleButton);
