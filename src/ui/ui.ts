...
export {Rect,IRectConfig,Shape,IShape,IShapeConfig as IShapeOpts,Canvas,ERectType as EObjectType,TextBox,Line,boundingShape,BoundingRect as BoundingShape,colorCreator}