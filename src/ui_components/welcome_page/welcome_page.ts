...
export class WelcomePage extends Shape{
    public windowBox:HorizontalBox;
    public sideBox:VerticalBox;
    public contentArea:Rect;

    public browseButton:HoverPressButton;
    public engineButton:HoverPressButton;
    ...
    private loadState(state:number){
